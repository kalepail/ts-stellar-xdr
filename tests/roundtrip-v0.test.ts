...
const VECTOR_7 =
  ''
  ...
  it('decodes and verifies fields', () => {
    ...
    if (op.body.type === 'MANAGE_SELL_OFFER') {
      ...
      if (offer.buying.type === 'ASSET_TYPE_CREDIT_ALPHANUM4') {
        ...
        const assetCodeStr = new TextDecoder().decode(assetCode).replaceAll('\u0000', '')
